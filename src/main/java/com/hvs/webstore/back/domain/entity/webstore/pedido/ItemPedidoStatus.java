...
public enum ItemPedidoStatus {
    ...
    ItemPedidoStatus(String aCode, String aDesc) {
        this.code = aCode;
        this.desc = aDesc;
    }

    public static ItemPedidoStatus findByCode(String aCode) {

        if (aCode != null) {
            for (ItemPedidoStatus status : values()) {
    ...
    public static ItemPedidoStatus findByDesc(String aDesc) {
