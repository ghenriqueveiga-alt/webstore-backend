...
public class IntroDetectado extends Entity<IntroDetectadoId> {

    public static final Instant INSTANT_BASE = Instant.EPOCH;

    private final IntroDetectadoUuid uuid;
    private final IntroDetectadoStatus status;
    ...
    private IntroDetectado(final IntroDetectadoId id,
                           final IntroDetectadoUuid uuid,
                           final IntroDetectadoStatus status,
    ...
    public static IntroDetectado create(final Long aEpisodioId,
        ...
        return new IntroDetectado(
                IntroDetectadoId.from(-1L),
                IntroDetectadoUuid.unique(),
                IntroDetectadoStatus.ACTIVE,
    ...
    public static IntroDetectado from(final Long aId,
                                      final String aUuid,
...
final Instant aDuracao,
        ...
        return new IntroDetectado(
                aId != null ? IntroDetectadoId.from(aId) : null,
                aUuid != null ? IntroDetectadoUuid.from(aUuid) : null,
                aStatusDesc != null ? IntroDetectadoStatus.findByDesc(aStatusDesc) : null,
                aEpisodio,
                aArquivo,
                aInicio,
                aDuracao,
    ...
    public void validate(final ValidationHandler aHandler) {
        ...
        new IntroDetectadoValidator(aHandler, this).validate();
    }

    public IntroDetectadoUuid getUuid() {
        return this.uuid;
    }
    public IntroDetectadoStatus getStatus() {
        return this.status;
    }
    ...
    public boolean equals(final Object o) {
        ...
        IntroDetectado that = (IntroDetectado) o;
