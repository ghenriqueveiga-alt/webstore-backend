...
public class UpdateFormaPagamentoUseCaseImpl extends UpdateFormaPagamentoUseCase {
    ...
    public UpdateFormaPagamentoUseCaseImpl(
    ...
    @Override
    public Either<Notification, UpdateFormaPagamentoOutput> execute(UpdateFormaPagamentoCommand aFormaPagamentoCommand) {
        ...
        var formaPagamento = FormaPagamento.update(aFormaPagamentoDB.get().getId().getValue(),
                                                   aFormaPagamentoDB.get().getUuid().getValue(),
                                                   aFormaPagamentoCommand.aStatusCode(),
                                                   aFormaPagamentoCommand.aUsuarioId(),
        ...
        return notification.hasError() ? Left(notification) : update(formaPagamento);
    }

    @Transactional
    private Either<Notification, UpdateFormaPagamentoOutput> update(FormaPagamento aFormaPagamento) {

        return Try(() -> gateway.update(aFormaPagamento))
                .toEither().bimap(Notification::create, UpdateFormaPagamentoOutput::from);
    }
}
