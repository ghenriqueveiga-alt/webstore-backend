...
public record ReadFreteOutput(Long id,
                              String uuid,
                              String status,
                              String cepOrigem,
                              String cepDestino,
    ...
    public static ReadFreteOutput from(Frete aFrete) {

        return new ReadFreteOutput(
    ...
    public static ReadFreteOutput fromSimple(Frete aFrete) {
