...
public class ReadEpisodioCortesTempoUseCaseImpl extends ReadEpisodioCortesTempoUseCase {
    ...
    @Override
    public Either<Notification, ReadEpisodioCortesTempoOutput> execute(ReadEpisodioCommand aIn) {
        ...
        final var cortesTempo = new java.util.ArrayList<CorteTempoOutput>();
        for (Corte corte : cortes) {
            ...
            cortesTempo.add(new CorteTempoOutput(
                    corte.getId().getValue(),
